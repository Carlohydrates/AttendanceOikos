					...
					<header>
                        ...
                        <div class="app-list-options">
                            ...
                            <div class="custom-select">
                                ...
                                <select id="gradeFilter" class="filter" onchange="getSections('gradeFilter', 'sectionFilter')"></select>
                            </div>
                        ...
                        <div class="custom-select" style="margin-right:20px;">
                            ...
                            <span style="margin-right:5px;"> Date <br> To </span> <input type="date" id="dateToFilter">
...
<script>
    function applyFilter() {
        ...
        var dateFrom = new Date(document.getElementById("dateFromFilter").value);
        var dateTo = new Date(document.getElementById("dateToFilter").value);
        ...
        for (var i = 2; i < rows.length; i++) {
            ...
            var gradeCell = row.getElementsByTagName("td")[1].innerText;
            var sectionCell = row.getElementsByTagName("td")[2].innerText;

            var dateCell = row.getElementsByTagName("td")[3].innerText.split('-');
            var formattedDateCell = new Date(dateCell[0] + '-' + dateCell[2] + '-' + dateCell[1]);
            
            if ((grade === "---" || grade === '' || gradeCell == grade) &&
                (section === '' || section == 'null' || sectionCell === section) &&    
                (name === "" || nameCell.includes(name)) &&
                (isNaN(dateFrom) || isNaN(dateTo) || dateFrom <= formattedDateCell && formattedDateCell <= dateTo)) {
                    row.style.display = "";
            } else {
    ...
    // Reset the display property of each row to an empty string
    for (var i = 2; i < rows.length; i++) {
